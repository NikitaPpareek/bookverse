            ...
            <form onSubmit={handleNewsletter} className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="you@email.com"
                  required
                  /* FIXED: Adjusted text class and placeholder adjustments to render cleanly under dark mode rules */
                  className="w-full pl-9 pr-3 py-2.5 rounded-xl bg-card dark:bg-dark-elevated border border-border dark:border-dark-border text-sm text-foreground dark:text-white dark:placeholder:text-muted/60 outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40"
                />
              </div>
              <button
                type="submit"
